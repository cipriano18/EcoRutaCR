...
class _SponsorRegistrationFormState extends State<SponsorRegistrationForm> {
  ...
  Future<void> _pickLocationFromMap() async {
    ...
    final selectedPoint = await Navigator.of(context).push<LatLng>(
      MaterialPageRoute(
        builder: (context) {
          return SponsorLocationPickerPage(
  ...
  bool _validateDates() {
    return _validateStartDate() == null && _validateEndDate() == null;
  }
  ...
  String? _validateStartDate() {
    return _startDate == null ? 'Selecciona la fecha de inicio.' : null;
  }
  ...
  String? _validateDescription(String? value) {
    ...
    if (normalized.length < 20) {
      return 'Describe un poco mas al patrocinador.';
    }
    return null;
  }
