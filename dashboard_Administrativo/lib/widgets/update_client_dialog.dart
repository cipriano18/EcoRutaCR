...
class UpdateClientDialog extends StatefulWidget {
  ...
  @override
  State<UpdateClientDialog> createState() =>
      _UpdateClientDialogState();
}

class _UpdateClientDialogState
    extends State<UpdateClientDialog> {
