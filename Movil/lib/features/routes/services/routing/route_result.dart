...
class RouteResult {
  ...
  /// Distancia formateada en metros o kilómetros según magnitud.
  ...
  /// Duración formateada para lectura rápida en tarjetas.
  ...
  /// Suma únicamente diferencias positivas entre puntos consecutivos.
