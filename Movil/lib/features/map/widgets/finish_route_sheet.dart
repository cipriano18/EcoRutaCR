...
/// Opciones de visibilidad disponibles al guardar una ruta registrada.
enum RouteVisibilityOption { private, public }

/// Datos mínimos que el usuario confirma antes de guardar una ruta.
class FinishRouteDraft {
  ...
  /// Nombre final de la ruta.
  final String title;

  /// Actividad asociada al recorrido.
  final RouteActivityOption activity;

  /// Visibilidad con la que se guardará la ruta.
  final RouteVisibilityOption visibility;
}

/// Resultado del formulario de cierre de ruta.
class FinishRouteSheetResult {
  ...
  /// Borrador válido cuando el usuario decide guardar.
  final FinishRouteDraft? draft;

  /// Indica si el usuario eligió descartar el recorrido.
  final bool discarded;
}

/// Hoja inferior para confirmar los datos de una ruta recién registrada.
class FinishRouteSheet extends StatefulWidget {
  ...
  /// Actividad sugerida por defecto.
  final RouteActivityOption initialActivity;

  /// Visibilidad sugerida por defecto.
  final RouteVisibilityOption initialVisibility;

  /// Callback invocado cuando el formulario es válido y se guarda.
  final ValueChanged<FinishRouteDraft> onSave;

  /// Callback invocado cuando el usuario descarta la ruta.
...
class _FinishRouteSheetState extends State<FinishRouteSheet> {
  ...
  /// Valida el formulario y entrega un [FinishRouteDraft] al contenedor.
  void _submit() {
...
/// Construye el estilo visual compartido de los campos de la hoja.
...
/// Selector segmentado usado para actividad y visibilidad.
